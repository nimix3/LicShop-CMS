        ...
        @if (sizeof(Cart::content()) > 0)
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td class="small-caps table-bg" style="text-align: right">قیمت محصولات</td>
                    ...
                    <tr>
                        <td class="table-image"></td>
                        <td></td>
                        <td class="small-caps table-bg" style="text-align: right">مالیات</td>
                    ...
                    <tr class="border-bottom">
                        ...
                        <td class="small-caps table-bg" style="text-align: right">قیمت کل:</td>
            ...
            <div style="float:right">
                <form action="{{ url('/emptyCart') }}" method="POST">
                    {!! csrf_field() !!}
                    <input type="hidden" name="_method" value="DELETE">
                    <input type="submit" class="btn btn-danger btn-lg" value="خالی کردن سبد">
                </form>
            </div>
